  ...
  return (
    ...
    >
      <div className="container mx-auto px-6 h-20 flex items-center justify-between">
        <a href="#hero" onClick={(e) => { e.preventDefault(); scrollTo("hero"); }} className="flex items-center gap-2 outline-none">
          <img src="/assets/logo.png" alt="Creative Web Studio Experts" className="h-10 w-auto" data-testid="img-logo-nav" />
        </a>

        <nav className="hidden md:flex items-center gap-8 font-medium">
          <a href="#services" onClick={(e) => { e.preventDefault(); scrollTo("services"); }} className="hover:text-[#0066FF] transition-colors" data-testid="link-services">Services</a>
          <a href="#why-us" onClick={(e) => { e.preventDefault(); scrollTo("why-us"); }} className="hover:text-[#0066FF] transition-colors" data-testid="link-why-us">Why Us</a>
          <a href="#portfolio" onClick={(e) => { e.preventDefault(); scrollTo("portfolio"); }} className="hover:text-[#0066FF] transition-colors" data-testid="link-portfolio">Portfolio</a>
          <a href="#pricing" onClick={(e) => { e.preventDefault(); scrollTo("pricing"); }} className="hover:text-[#0066FF] transition-colors" data-testid="link-pricing">Pricing</a>
          <a href="#testimonials" onClick={(e) => { e.preventDefault(); scrollTo("testimonials"); }} className="hover:text-[#0066FF] transition-colors" data-testid="link-testimonials">Reviews</a>
          <a
        ...
        {mobileMenuOpen && (
          ...
          >
            <div className="px-6 py-4 flex flex-col gap-4">
              <a href="#services" onClick={(e) => { e.preventDefault(); scrollTo("services"); }} className="text-left py-2 border-b border-gray-800">Services</a>
              <a href="#why-us" onClick={(e) => { e.preventDefault(); scrollTo("why-us"); }} className="text-left py-2 border-b border-gray-800">Why Us</a>
              <a href="#portfolio" onClick={(e) => { e.preventDefault(); scrollTo("portfolio"); }} className="text-left py-2 border-b border-gray-800">Portfolio</a>
              <a href="#pricing" onClick={(e) => { e.preventDefault(); scrollTo("pricing"); }} className="text-left py-2 border-b border-gray-800">Pricing</a>
              <a href="#testimonials" onClick={(e) => { e.preventDefault(); scrollTo("testimonials"); }} className="text-left py-2 border-b border-gray-800">Reviews</a>
              <a href="#contact" onClick={(e) => { e.preventDefault(); scrollTo("contact"); }} className="text-left py-2 text-[#0066FF] font-bold">Get Started</a>
      ...
      <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            >
              <a href="#portfolio" onClick={(e) => { e.preventDefault(); document.getElementById("portfolio")?.scrollIntoView({ behavior: "smooth" }); }}>View Our Work</a>
            </Button>
          </div>
