          ...
          >
            ...
            <div className="space-y-6">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-5 p-5 bg-[#25D366]/10 border border-[#25D366]/30 rounded-2xl hover:bg-[#25D366]/20 transition-colors group"
                data-testid="link-whatsapp-contact"
              >
                <div className="w-14 h-14 bg-[#25D366] rounded-2xl flex items-center justify-center flex-shrink-0 shadow-lg shadow-green-500/30 group-hover:scale-105 transition-transform">
                ...
                <div>
                  <p className="text-sm text-gray-400 font-medium">Message Us on WhatsApp</p>
                  <p className="text-xl font-bold text-white">+44 7907 313846</p>
                </div>
              </a>
      ...
      <div className="container mx-auto px-6 text-center md:text-left">
        ...
        <div className="pt-8 border-t border-gray-900 text-sm flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-4">
            <div className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-[#0066FF] hover:text-white cursor-pointer transition-colors">
  ...
  return (
    <div className="min-h-screen bg-white selection:bg-[#0066FF] selection:text-white font-sans text-[#1a1a2e]">
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.95 }}
        className="fixed bottom-6 right-6 z-50 flex items-center gap-3 bg-[#25D366] text-white pl-4 pr-5 py-3 rounded-full shadow-2xl shadow-green-500/40 hover:shadow-green-500/60 transition-shadow group"
      >
