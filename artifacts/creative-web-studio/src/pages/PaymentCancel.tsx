  ...
  return (
    <div className="min-h-screen bg-[#FAFCFF] flex items-center justify-center px-6">
      ...
      >
        ...
        <h1 className="text-3xl font-bold text-[#1a1a2e] mb-4">Payment Cancelled</h1>
        <p className="text-gray-600 text-lg mb-8 leading-relaxed">
          No worries — your payment was cancelled and nothing has been charged. If you have any questions or need help choosing the right package, we're here.
        </p>
